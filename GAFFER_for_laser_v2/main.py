...
from my_soea_DE_best_1_L_templet import my_soea_DE_best_1_L_templet
...
myAlgorithm = my_soea_DE_best_1_L_templet(problem, population)# instantiate a template object
...
BestIndi.save()
np.save("best_info",myAlgorithm.best)
